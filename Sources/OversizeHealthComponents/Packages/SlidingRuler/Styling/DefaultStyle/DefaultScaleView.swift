...
struct DefaultScaleView: ScaleView {
    struct ScaleShape: Shape {
        fileprivate var unitMarkSize: CGSize { .init(width: 2.0, height: 54.0) }
        fileprivate var halfMarkSize: CGSize { .init(width: UIScreen.main.scale == 3 ? 1.8 : 2.0, height: 28.0) }
        fileprivate var fractionMarkSize: CGSize { .init(width: 2.0, height: 16.0) }
    ...
    init(width: CGFloat, height: CGFloat = 132) {
        self.width = width
        self.height = height
    }
}
