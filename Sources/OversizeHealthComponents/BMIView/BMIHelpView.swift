...
struct BMIHelpView: View {
    ...
    var infoListView: some View {
        VStack(spacing: 2) {
            bmiRow(value: "16.0", title: "Underweight", description: "Severe thinness", color: .blue, icon: Icon(.chevronLeft, color: .onPrimaryHighEmphasis))
            ...
            bmiRow(value: "40", title: "Obese", description: "Class III", color: .red, icon: Icon(.chevronRight, color: .onPrimaryHighEmphasis))
        }
    }
